<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/job/bulkEdit')); ?>"
                        ...
                        <button data-confirm="<?php echo e(__('Do you want to delete?')); ?>"
                            class="btn-default btn btn-icon dungdt-apply-form-btn"
                            type="button"><?php echo e(__('Apply')); ?></button>
                    </form>
                <?php endif; ?>
            </div>
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(route('job.admin.index')); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/failamir/Sites/localhost/superio200/modules/Job/Views/admin/job/index.blade.php ENDPATH**/ ?>