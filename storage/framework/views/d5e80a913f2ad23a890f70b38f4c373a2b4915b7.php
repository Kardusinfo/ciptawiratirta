...
<section class="call-to-action-two" <?php if(!empty($bg_image_url)): ?> style="background-image: url(<?php echo e($bg_image_url ?? ""); ?>) !important;" <?php endif; ?>>
    <div class="auto-container">
        ...
        <div class="btn-box">
            ...
            <a href="<?php echo e('/page/recruitment-procedure'); ?>" class="theme-btn btn-style-two">Recruitment Procedure</a>
        </div>
    </div>
</section>
<?php /**PATH /Users/failamir/Sites/localhost/superio200/modules/Template/Views/frontend/blocks/call-to-action/style_1.blade.php ENDPATH**/ ?>