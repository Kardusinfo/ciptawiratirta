    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.users.update", [$user->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('first_name') ? 'is-invalid' : ''); ?>" type="text" name="first_name" id="first_name" value="<?php echo e(old('first_name', $user->first_name)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('last_name') ? 'is-invalid' : ''); ?>" type="text" name="last_name" id="last_name" value="<?php echo e(old('last_name', $user->last_name)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('ktp') ? 'is-invalid' : ''); ?>" type="text" name="ktp" id="ktp" value="<?php echo e(old('ktp', $user->ktp)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('passport') ? 'is-invalid' : ''); ?>" type="text" name="passport" id="passport" value="<?php echo e(old('passport', $user->passport)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('visa') ? 'is-invalid' : ''); ?>" type="text" name="visa" id="visa" value="<?php echo e(old('visa', $user->visa)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('bst_ccm') ? 'is-invalid' : ''); ?>" type="text" name="bst_ccm" id="bst_ccm" value="<?php echo e(old('bst_ccm', $user->bst_ccm)); ?>">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone <?php echo e($errors->has('cv') ? 'is-invalid' : ''); ?>" id="cv-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone <?php echo e($errors->has('skk') ? 'is-invalid' : ''); ?>" id="skk-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('country') ? 'is-invalid' : ''); ?>" type="text" name="country" id="country" value="<?php echo e(old('country', $user->country)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('address') ? 'is-invalid' : ''); ?>" type="text" name="address" id="address" value="<?php echo e(old('address', $user->address)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control date <?php echo e($errors->has('b_o_d') ? 'is-invalid' : ''); ?>" type="text" name="b_o_d" id="b_o_d" value="<?php echo e(old('b_o_d', $user->b_o_d)); ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('office_registered') ? 'is-invalid' : ''); ?>" name="office_registered_id" id="office_registered_id">
                    <?php $__currentLoopData = $office_registereds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('office_registered_id') ? old('office_registered_id') : $user->office_registered->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::VC_YF_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('vc_yf') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="vc_yf_<?php echo e($key); ?>" name="vc_yf" value="<?php echo e($key); ?>" <?php echo e(old('vc_yf', $user->vc_yf) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="vc_yf_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::VC_COVID_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('vc_covid') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="vc_covid_<?php echo e($key); ?>" name="vc_covid" value="<?php echo e($key); ?>" <?php echo e(old('vc_covid', $user->vc_covid) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="vc_covid_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('age') ? 'is-invalid' : ''); ?>" type="text" name="age" id="age" value="<?php echo e(old('age', $user->age)); ?>">
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::CID_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('cid') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="cid_<?php echo e($key); ?>" name="cid" value="<?php echo e($key); ?>" <?php echo e(old('cid', $user->cid) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="cid_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php echo e($errors->has('coc') ? 'is-invalid' : ''); ?>" name="coc" id="coc">
                    <option value disabled <?php echo e(old('coc', null) === null ? 'selected' : ''); ?>><?php echo e(trans('global.pleaseSelect')); ?></option>
                    <?php $__currentLoopData = App\Models\User::COC_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(old('coc', $user->coc) === (string) $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::RATING_ABLE_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('rating_able') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="rating_able_<?php echo e($key); ?>" name="rating_able" value="<?php echo e($key); ?>" <?php echo e(old('rating_able', $user->rating_able) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="rating_able_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::CCM_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('ccm') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="ccm_<?php echo e($key); ?>" name="ccm" value="<?php echo e($key); ?>" <?php echo e(old('ccm', $user->ccm) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="ccm_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('experiences') ? 'is-invalid' : ''); ?>" name="experiences[]" id="experiences" multiple>
                    <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((in_array($id, old('experiences', [])) || $user->experiences->contains($id)) ? 'selected' : ''); ?>><?php echo e($experience); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = App\Models\User::APPLICATION_FORM_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check <?php echo e($errors->has('application_form') ? 'is-invalid' : ''); ?>">
                        <input class="form-check-input" type="radio" id="application_form_<?php echo e($key); ?>" name="application_form" value="<?php echo e($key); ?>" <?php echo e(old('application_form', $user->application_form) === (string) $key ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="application_form_<?php echo e($key); ?>"><?php echo e($label); ?></label>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('contact_no') ? 'is-invalid' : ''); ?>" type="text" name="contact_no" id="contact_no" value="<?php echo e(old('contact_no', $user->contact_no)); ?>">
