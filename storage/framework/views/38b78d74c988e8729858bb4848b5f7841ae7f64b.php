            ...
            <form method="POST" action="<?php echo e(route('admin.users.update', [$user->id])); ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control <?php echo e($errors->has('passport') ? 'is-invalid' : ''); ?>" type="text"
                            name="passport" id="passport" value="<?php echo e(old('passport', $user->passport)); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control date <?php echo e($errors->has('b_o_d') ? 'is-invalid' : ''); ?>" type="text"
                            name="b_o_d" id="b_o_d" value="<?php echo e(old('b_o_d', $user->b_o_d)); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 <?php echo e($errors->has('office_registered') ? 'is-invalid' : ''); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php echo e($errors->has('coc') ? 'is-invalid' : ''); ?>" name="coc"
                            ...
                            <?php $__currentLoopData = App\Models\User::COC_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>"
                                    <?php echo e(old('coc', $user->coc) === (string) $key ? 'selected' : ''); ?>><?php echo e($label); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo e($errors->has('contact_no') ? 'is-invalid' : ''); ?>" type="text"
                            name="contact_no" id="contact_no" value="<?php echo e(old('contact_no', $user->contact_no)); ?>">
