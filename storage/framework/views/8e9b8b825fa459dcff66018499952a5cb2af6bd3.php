<div class="btn-box">
    <?php if($row->isOpen()): ?>
        <?php switch($row->apply_type):
            case ('email'): ?>
                <a href="mailto:<?php echo e($row->apply_email ?? ($row->company->email ?? '')); ?>" target="_blank" rel="nofollow"
                    class="theme-btn btn-style-one"><?php echo e(__('Apply For Job')); ?></a>
            <?php break; ?>

            <?php case ('external'): ?>
                <a href="<?php echo e($row->apply_link); ?>" target="_blank" rel="nofollow"
                    class="theme-btn btn-style-one"><?php echo e(__('Apply For Job')); ?></a>
            <?php break; ?>
            ...
            <?php default: ?>
                ...
                <?php $uriSegments = explode("/", parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)); ?>
                    <a href="/register?job=<?php echo e($uriSegments[2]); ?>" class="theme-btn btn-style-one "><?php echo e(__('Apply For Job')); ?></a>
                <?php else: ?>
                    <?php if($applied): ?>
    ...
    <?php endif; ?>
    <button class="bookmark-btn service-wishlist <?php if($row->wishlist): ?> active <?php endif; ?>"
        data-id="<?php echo e($row->id); ?>" data-type="<?php echo e($row->type); ?>"><i class="flaticon-bookmark"></i></button>
</div>
<?php /**PATH /Users/failamir/Sites/localhost/superio200/modules/Job/Views/frontend/layouts/details/apply-button.blade.php ENDPATH**/ ?>