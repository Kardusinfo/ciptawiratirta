                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control {{ $errors->has('passport') ? 'is-invalid' : '' }}" type="text"
                            name="passport" id="passport" value="{{ old('passport', $user->passport) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('b_o_d') ? 'is-invalid' : '' }}" type="text"
                            name="b_o_d" id="b_o_d" value="{{ old('b_o_d', $user->b_o_d) }}">
                        @if ($errors->has('b_o_d'))
                            <div class="invalid-feedback">
                                {{ $errors->first('b_o_d') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('office_registered') ? 'is-invalid' : '' }}"
                    ...
                    <div class="form-group">
                        ...
                        @foreach (App\Models\User::VC_YF_RADIO as $key => $label)
                            <div class="form-check {{ $errors->has('vc_yf') ? 'is-invalid' : '' }}">
                                <input class="form-check-input" type="radio" id="vc_yf_{{ $key }}"
                    ...
                    <div class="form-group">
                        ...
                        @foreach (App\Models\User::VC_COVID_RADIO as $key => $label)
                            <div class="form-check {{ $errors->has('vc_covid') ? 'is-invalid' : '' }}">
                                <input class="form-check-input" type="radio" id="vc_covid_{{ $key }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('coc') ? 'is-invalid' : '' }}" name="coc"
                            ...
                            @foreach (App\Models\User::COC_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('coc', $user->coc) === (string) $key ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                        @if ($errors->has('coc'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('contact_no') ? 'is-invalid' : '' }}" type="text"
                            name="contact_no" id="contact_no" value="{{ old('contact_no', $user->contact_no) }}">
